    ...
    <el-row class="container">
        <el-col :span="24" class="header">
            ...
            <el-col :span="10">
                ...
                <el-menu :default-active="$route.path" class="el-menu-demo" mode="horizontal" id="menuA" @open="handleopen" @close="handleclose" @select="handleselect" unique-opened router v-show="!collapsed">
