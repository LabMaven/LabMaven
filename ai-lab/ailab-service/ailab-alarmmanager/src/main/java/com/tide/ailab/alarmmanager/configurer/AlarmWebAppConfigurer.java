...
@Configuration
@EnableWebMvc
public class AlarmWebAppConfigurer extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		String[] excludePathPatterns = {"/websocket-alarm","/alarm/collectAlarmInfo","/swagger**", "/swagger-resources/configuration/ui",
